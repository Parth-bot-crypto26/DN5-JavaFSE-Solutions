-- Hands on 1: Populate country table
-- (Full country list adapted from the hands-on doc's insert script)
...
-- Hands on 3: payroll schema sample data (Department, Skill, Employee)
...
insert into skill (sk_id, sk_name) values (4, 'Negotiation');

insert into employee (em_id, em_name, em_salary, em_permanent, em_date_of_birth, em_dp_id) values (1, 'Alice Johnson', 85000, true, '1990-04-12', 1);
insert into employee (em_id, em_name, em_salary, em_permanent, em_date_of_birth, em_dp_id) values (2, 'Bob Smith', 72000, true, '1988-11-02', 1);
insert into employee (em_id, em_name, em_salary, em_permanent, em_date_of_birth, em_dp_id) values (3, 'Carla Diaz', 65000, false, '1995-07-23', 2);
insert into employee (em_id, em_name, em_salary, em_permanent, em_date_of_birth, em_dp_id) values (4, 'David Lee', 91000, true, '1985-01-30', 3);
insert into employee (em_id, em_name, em_salary, em_permanent, em_date_of_birth, em_dp_id) values (5, 'Emma Brown', 58000, false, '1998-09-14', 2);
